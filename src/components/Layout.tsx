      ...
      <footer className="border-t border-border">
        <div className="container py-6 flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-5">
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-foreground transition-colors">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-foreground transition-colors">
            ...
            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/50 hover:text-foreground transition-colors">
          ...
          <span className="text-xs text-muted-foreground/40">© 2026 ANERFY. Todos los derechos reservados.</span>
        </div>
      </footer>
    </div>
  );
