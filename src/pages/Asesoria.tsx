  ...
  if (done) {
    return (
      <div className="rounded-2xl border border-border bg-card/70 p-8">
        ...
        {/* Pitch de Alberto: generar deseo mostrando valor sin revelar el producto */}
        <div className="mt-7 rounded-2xl border border-primary/20 bg-gradient-to-b from-primary/8 to-primary/4 p-8">
          <h4 className="font-display text-xl font-semibold text-foreground">
            Esto es apenas el 10% de tu foto.
          </h4>
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground">
            Acabas de ver una lectura preliminar con 7 variables — suficiente para intuir por dónde anda tu caso,
            no para moverte con certeza. Lo que de verdad decide tu proceso está en lo que esta vista <strong className="text-foreground">no te muestra</strong>:
            cuánto te costará exactamente por fase, qué ruta de visa te corresponde, qué documentos pedir y en qué orden,
            y en qué Bundesland tienes hoy la mejor oportunidad según tu perfil.
          </p>
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground">
            Sin eso seguirás avanzando a ciegas — y cada mes sin un plan adaptado es tiempo y dinero que no se recuperan.
            Desbloquea tu roadmap completo y permanente, y siéntate con un consultor que lo recorra contigo paso a paso
            hasta que no te quede una sola duda.
          </p>
        </div>

        {/* Bloque de vista previa bloqueada (teasers con candado) */}
        <div className="mt-6 rounded-2xl border border-border/50 bg-secondary/20 p-6">
          ...
          <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
            <div className="flex items-center gap-3 rounded-lg bg-secondary/30 px-4 py-3">
              ...
              <div className="text-sm">
                <p className="font-medium text-foreground/70">🔒 Bundesland recomendado</p>
                <p className="text-xs text-muted-foreground mt-0.5">Desbloquéalo</p>
              </div>
            </div>
            <div className="flex items-center gap-3 rounded-lg bg-secondary/30 px-4 py-3">
              <Wallet className="h-5 w-5 text-muted-foreground opacity-50" />
              <div className="text-sm">
                <p className="font-medium text-foreground/70">🔒 Presupuesto por fases</p>
            ...
            <div className="flex items-center gap-3 rounded-lg bg-secondary/30 px-4 py-3">
              ...
              <div className="text-sm">
                <p className="font-medium text-foreground/70">🔒 Documentos ordenados</p>
                <p className="text-xs text-muted-foreground mt-0.5">12 pasos identificados</p>
              </div>
            </div>
            <div className="flex items-center gap-3 rounded-lg bg-secondary/30 px-4 py-3">
              <ShieldCheck className="h-5 w-5 text-muted-foreground opacity-50" />
              <div className="text-sm">
                <p className="font-medium text-foreground/70">🔒 Ruta de visa personalizada</p>
                <p className="text-xs text-muted-foreground mt-0.5">Desbloquéala</p>
              </div>
            </div>
            <div className="flex items-center gap-3 rounded-lg bg-secondary/30 px-4 py-3">
              <Clock className="h-5 w-5 text-muted-foreground opacity-50" />
              <div className="text-sm">
                <p className="font-medium text-foreground/70">🔒 Línea de tiempo estimada</p>
                <p className="text-xs text-muted-foreground mt-0.5">• • meses</p>
              </div>
            </div>
            <div className="flex items-center gap-3 rounded-lg bg-secondary/30 px-4 py-3">
              <BarChart3 className="h-5 w-5 text-muted-foreground opacity-50" />
              <div className="text-sm">
                <p className="font-medium text-foreground/70">🔒 Anerfy Score real (50+ vars)</p>
                <p className="text-xs text-muted-foreground mt-0.5">Desbloquéalo</p>
              </div>
            </div>
          </div>
        ...
        {/* CTA Paywall con lista de incluye */}
        <div className="mt-7 rounded-2xl border border-primary/30 bg-primary/5 p-6 md:p-8">
          <h4 className="font-display text-2xl font-semibold text-center">Desbloquea tu diagnóstico completo + roadmap</h4>
          <p className="mx-auto mt-3 max-w-lg text-sm text-center text-muted-foreground">
            {PRECIO ? <strong className="text-foreground text-base">{PRECIO}, pago único.</strong> : <strong className="text-foreground text-base">Próximamente.</strong>}
          </p>
          ...
          <ul className="mx-auto mt-6 max-w-2xl space-y-3">
            <li className="flex items-start gap-3 text-sm">
              ...
              <span><strong className="text-foreground">Roadmap completo y permanente</strong> en tu perfil Anerfy — seguimiento continuo, sin fecha de vencimiento</span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <CheckCircle2 className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
              <span><strong className="text-foreground">Asesoría 1:1 de 90 min</strong> con un consultor experto para navegar tu homologación y aclarar cada duda</span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <CheckCircle2 className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
              <span><strong className="text-foreground">Anerfy Score real</strong> cruzando 50+ variables de tu caso (no las 7 de la vista previa)</span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <CheckCircle2 className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
              <span><strong className="text-foreground">Plan accionable</strong>: ruta de visa, presupuesto por fases, documentos ordenados y Bundesland recomendado</span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <CheckCircle2 className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
              <span><strong className="text-foreground">Acceso exclusivo a la bolsa de trabajo Anerfy</strong> — vacantes en Alemania para clientes</span>
            </li>
            <li className="flex items-start gap-3 text-sm">
              <CheckCircle2 className="h-5 w-5 text-success flex-shrink-0 mt-0.5" />
              <span><strong className="text-foreground">Garantía 100%</strong>: si el roadmap no corresponde a tu caso, te devolvemos tu inversión</span>
            </li>
          </ul>

          <Button size="lg" onClick={handleCheckout} disabled={checkingOut}
                  className="mt-7 h-14 w-full px-8 text-base font-semibold shadow-lg shadow-primary/20">
            {checkingOut
    ...
    <form onSubmit={handleSubmit} className="rounded-2xl border border-border bg-card/70 p-6 md:p-8">
      ...
      <Button type="submit" size="lg" disabled={loading}
        ...
        {loading
          ...
          : <><BarChart3 className="mr-2 h-5 w-5" /> Ver mi orientación + acceso a anabin</>}
      </Button>
      <p className="mt-3 text-center text-xs text-muted-foreground">
        Gratis y sin compromiso. Tu orientación aparece al instante.
      </p>
    </form>
  );
}
