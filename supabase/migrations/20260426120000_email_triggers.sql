-- Email automation triggers using pg_net / net.http_post
-- Trigger A: diagnostic-link on INSERT into diagnostic_tokens
-- Trigger B: diagnostico-nuevo-asesor on submission completed
-- Trigger C: acceso-presentacion on client_access_unlocked = true
