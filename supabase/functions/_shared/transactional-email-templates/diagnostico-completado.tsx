...
interface DiagnosticoCompletadoProps {
  nombre?: string
  bookingUrl?: string
}

const DiagnosticoCompletadoEmail = ({ nombre, bookingUrl }: DiagnosticoCompletadoProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Recibimos tu diagnóstico — agenda tu asesoría de 90 min</Preview>
    <Body style={main}>
      ...
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          Un asesor lo revisa antes de tu sesión para llegar con un plan
          adaptado a tu caso real.
        </Text>

        <Heading style={h2}>Próximo paso: agenda tu asesoría</Heading>

        <Text style={text}>
          Es una sesión de <strong style={bold}>90 minutos</strong> donde
          repasamos tu diagnóstico, identificamos bloqueos y salimos con un
          roadmap concreto: documentos, idioma, plazos y financiamiento.
        </Text>
        ...
        <Text style={linkNote}>
          Elige el horario que mejor te quede. Recibirás confirmación
          automática y un recordatorio antes de la cita.
        </Text>
...
export const template = {
  component: DiagnosticoCompletadoEmail,
  subject: 'Recibimos tu diagnóstico — agenda tu asesoría',
