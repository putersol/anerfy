...
const BookingReminder2Email = ({ nombre, bookingUrl }: BookingReminderProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Tu asesoría te está esperando</Preview>
    <Body style={main}>
      ...
      <Container style={container}>
        <Heading style={h1}>
          {nombre ? `${nombre}, ` : ''}tu asesoría te está esperando.
        </Heading>

        <Text style={text}>
          Hace unos días completaste tu diagnóstico. Tu asesor ya lo revisó
          y tiene el plan inicial listo, pero necesitamos que elijas un
          horario para repasarlo contigo en la
          <strong style={bold}> asesoría de 90 min</strong>.
        </Text>

        <Text style={text}>
          La mayoría de clientes que dejan pasar más tiempo terminan
          atascados en el mismo punto del diagnóstico. Mejor avanzar
          ahora que tu información está fresca.
        </Text>
        ...
        <Text style={linkNote}>
          ¿Algo te frena? Responde este email y vemos cómo destrabarlo.
        </Text>
...
export const template = {
  component: BookingReminder2Email,
  subject: 'Tu asesoría te está esperando',
